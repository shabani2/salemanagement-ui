...
const pointVenteAdapter: EntityAdapter<PointVente, string> =
  createEntityAdapter<PointVente, string>({
...
export const selectPointVenteStatus = (state: RootState) =>
  state.pointVentes.status;
export const selectPointVenteError = (state: RootState) =>
  state.pointVentes.error;
