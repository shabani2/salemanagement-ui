...
const AdminPVDashboard = dynamic(
  () => import("@/app/Admin_pv/Dashboard/page"),
  { ssr: false },
);
...
const AdminPVCommandes = dynamic(
  () => import("@/app/Admin_pv/commandes/page"),
  { ssr: false },
);

// 📌 AdminZone
const AdminZoneDashboard = dynamic(
  () => import("@/app/Admin_zone/Dashboard/page"),
  { ssr: false },
);
const AdminZonePointsVente = dynamic(
  () => import("@/app/Admin_zone/pointVentes/page"),
  { ssr: false },
);
const AdminZoneAdminsPV = dynamic(
  () => import("@/app/Admin_zone/AdminPvs/page"),
  { ssr: false },
);
...
const AdminZoneCommandes = dynamic(
  () => import("@/app/Admin_zone/commandes/page"),
  { ssr: false },
);

// 📌 SuperAdmin
const SuperAdminDashboard = dynamic(
  () => import("@/app/superAdmin/Dashboard/page"),
  { ssr: false },
);
...
const SuperAdminParametres = dynamic(
  () => import("@/app/superAdmin/Parametres/page"),
  { ssr: false },
);
...
const VendeurHistorique = dynamic(
  () => import("@/app/Vendeurs/historiques/page"),
  { ssr: false },
);
